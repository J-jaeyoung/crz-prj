...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E00C0 0x013F3F07 0x01010803
...
set psu_ddr_init_data {
    ...
    mask_write 0XFD070110 0x1F0F0F1F 0x0A04040C
    ...
    mask_write 0XFD0701A0 0xC3FF03FF 0x83FF0003
    ...
    mask_write 0XFD080110 0xFFFFFFFF 0x08221708
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180204 0x003FDFBF 0x00240000
...
set psu_afi_config {
    ...
    mask_write 0XFD615000 0x00000F00 0x00000500
