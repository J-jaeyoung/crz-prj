...
HD_PWD='C:/daisyplus_openssd_micron_4c2w_80mhz_from_50mhz_real/cosm-plus-sys/cosm-plus-sys.runs/sys_top_auto_pc_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sys_top_auto_pc_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sys_top_auto_pc_2.tcl
