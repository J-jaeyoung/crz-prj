...
HD_PWD='D:/sources/DaisyPlus/NAND/Micron/OpenSSD/512bit/daisyplus_openssd_micron_4c2w/cosm-plus-sys/cosm-plus-sys.runs/sys_top_xbar_10_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sys_top_xbar_10.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sys_top_xbar_10.tcl
