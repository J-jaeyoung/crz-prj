...
(
    ...
    localparam  State_NCmdWrite1    = 4'b0100   ;
    localparam  State_NTMIssue      = 4'b1100   ;
    localparam  State_WaitDone      = 4'b1101   ;
    ...
    always @ (*)
        case (rCurState)
        State_NCALIssue:
            rNumOfData[15:0] <= 16'd4 - ((rDoNotCommit)?16'd1:16'd0) + ((rEraseResume)?16'd1:16'd0);
        State_NTMIssue:
    ...
    always @ (posedge iSystemClock)
        if (iReset)
            ...
            State_NCmdPreset:
                rCAData <= 8'h27;
            State_NCmdWrite0:
                rCAData <= (rMultiplaneSuspend)?8'hFA:8'h60;
            State_NAddrWrite0:
