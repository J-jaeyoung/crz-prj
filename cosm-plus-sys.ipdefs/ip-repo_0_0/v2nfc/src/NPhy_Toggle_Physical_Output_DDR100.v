...
(
    ...
    (
        ...
        //.TBYTEOUT   (                       ),
        //.TFB        (                       ),
        .T_OUT      (oDQSOutEnableToPinpad  ), // to pinpad
    ...
    begin : DQOSERDESBits
        ...
        (
            ...
            //.TBYTEOUT   (                   ),
            //.TFB        (                   ),
            .T_OUT      (oDQOutEnableToPinpad[c]), // to pinpad
    ...
    begin : CEOSERDESBits
        ...
        (
            ...
            .CLK        (iOutputDrivingClock    ),
            .CLKDIV     (iSystemClock           ),
            .D          (~{iPO_ChipEnable[NumberOfWays + d],
