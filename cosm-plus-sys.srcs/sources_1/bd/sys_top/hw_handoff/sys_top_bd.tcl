...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.CLKIN1_JITTER_PS {150.0} \
   CONFIG.CLKOUT1_DRIVES {BUFG} \
   CONFIG.CLKOUT1_JITTER {119.068} \
   CONFIG.CLKOUT1_PHASE_ERROR {121.857} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {133.333} \
   CONFIG.CLKOUT2_DRIVES {BUFG} \
   CONFIG.CLKOUT2_JITTER {136.531} \
   CONFIG.CLKOUT2_PHASE_ERROR {121.857} \
   CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {66.666} \
   CONFIG.CLKOUT2_USED {true} \
   CONFIG.CLKOUT3_DRIVES {BUFG} \
   CONFIG.CLKOUT3_JITTER {103.813} \
   CONFIG.CLKOUT3_PHASE_ERROR {121.857} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__ACT_FREQMHZ {66.666000} \
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__DIVISOR0 {15} \
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__DIVISOR1 {1} \
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__FREQMHZ {66.666} \
