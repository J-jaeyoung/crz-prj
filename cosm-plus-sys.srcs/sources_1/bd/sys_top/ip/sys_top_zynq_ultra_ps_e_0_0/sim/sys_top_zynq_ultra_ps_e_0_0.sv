...
//PORTS
      ...
      bit  maxigp0_awready;
      bit  [63 : 0] maxigp0_wdata;
      bit  [7 : 0] maxigp0_wstrb;
      bit  maxigp0_wlast;
      bit  maxigp0_wvalid;
      bit  maxigp0_wready;
...
//PARAMETERS
      ...
      parameter C_MAXIGP0_DATA_WIDTH = 64;
      ...
      parameter C_NUM_FABRIC_RESETS = 4;
...
//REG DECLARATIONS
      ...
      reg [63 : 0] maxigp0_wdata;
      reg [7 : 0] maxigp0_wstrb;
      reg maxigp0_wlast;
      reg maxigp0_wvalid;
      reg maxigp0_bready;
...
import "DPI-C" function void ps8_simulate_single_cycle_pl_clk3();
   ...
   export "DPI-C" function ps8_set_output_pins_pl_resetn1;
   function void ps8_set_output_pins_pl_resetn1(int value);
       pl_resetn1 = 1'b1; 
   endfunction

   export "DPI-C" function ps8_set_output_pins_pl_resetn2;
   function void ps8_set_output_pins_pl_resetn2(int value);
       pl_resetn2 = 1'b1; 
   endfunction

   export "DPI-C" function ps8_set_output_pins_pl_resetn3;
   function void ps8_set_output_pins_pl_resetn3(int value);
       pl_resetn3 = 1'b1; 
   endfunction
...
//INITIAL BLOCK
  ...
  always #(7.500075000750008) pl_clk0 <= ~pl_clk0;
