...
-- Date        : Thu Dec 21 13:58:21 2023
-- Host        : Guardian running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               C:/daisyplus_openssd_micron_4c2w_80mhz_from_50mhz_real/cosm-plus-sys/cosm-plus-sys.srcs/sources_1/bd/sys_top/ip/sys_top_zynq_ultra_ps_e_0_0/sys_top_zynq_ultra_ps_e_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of sys_top_zynq_ultra_ps_e_0_0 is
 ...
 " LPDDR4_DQ31, , , INOUT, PS_DDR_DQ31_504, LPDDR4, , , ,PS_LPDDR4_DQ_OUT40|PS_LPDDR4_DQ_IN40, RTT_40, 40";
  attribute PSS_JITTER : string;
  attribute PSS_JITTER of inst : label is "<PSS_EXTERNAL_CLOCKS><EXTERNAL_CLOCK name={PLCLK[0]} clock_external_divide={5} vco_name={DPLL} vco_freq={2399.976} vco_internal_divide={2}/><EXTERNAL_CLOCK name={PLCLK[1]} clock_external_divide={2} vco_name={DPLL} vco_freq={2399.976} vco_internal_divide={2}/><EXTERNAL_CLOCK name={PLCLK[2]} clock_external_divide={5} vco_name={RPLL} vco_freq={1999.980} vco_internal_divide={2}/><EXTERNAL_CLOCK name={PLCLK[3]} clock_external_divide={4} vco_name={RPLL} vco_freq={1999.980} vco_internal_divide={2}/></PSS_EXTERNAL_CLOCKS>";
  attribute PSS_POWER : string;
  ...
  attribute X_INTERFACE_PARAMETER of pl_clk0 : signal is "XIL_INTERFACENAME PL_CLK0, FREQ_HZ 79999199, PHASE 0.000, CLK_DOMAIN sys_top_zynq_ultra_ps_e_0_0_pl_clk0, INSERT_VIP 0";
