...
create_clock -period 12.500 -name nand_ch0_virt_clk
create_clock -period 12.500 -name nand_ch0_dqs_as_clk [get_ports nand_if_0_nand_dqs_p]
...
set_input_delay -clock [get_clocks nand_ch0_virt_clk] -max 0.700 [get_ports {nand_if_0_nand_dq[*]}]
set_input_delay -clock [get_clocks nand_ch0_virt_clk] -clock_fall -max -add_delay 0.700 [get_ports {nand_if_0_nand_dq[*]}]
set_input_delay -clock [get_clocks nand_ch0_virt_clk] -min -add_delay -0.700 [get_ports {nand_if_0_nand_dq[*]}]
set_input_delay -clock [get_clocks nand_ch0_virt_clk] -clock_fall -min -add_delay -0.700 [get_ports {nand_if_0_nand_dq[*]}]
set_output_delay -clock [get_clocks nand_ch0_dqs_as_clk] -max 0.700 [get_ports {nand_if_0_nand_dq[*]}]
set_output_delay -clock [get_clocks nand_ch0_dqs_as_clk] -clock_fall -max -add_delay 0.700 [get_ports {nand_if_0_nand_dq[*]}]
set_output_delay -clock [get_clocks nand_ch0_dqs_as_clk] -min -add_delay -0.700 [get_ports {nand_if_0_nand_dq[*]}]
set_output_delay -clock [get_clocks nand_ch0_dqs_as_clk] -clock_fall -min -add_delay -0.700 [get_ports {nand_if_0_nand_dq[*]}]
...
create_clock -period 12.500 -name nand_ch1_virt_clk
create_clock -period 12.500 -name nand_ch1_dqs_as_clk [get_ports nand_if_1_nand_dqs_p]
...
create_clock -period 12.500 -name nand_ch2_virt_clk
create_clock -period 12.500 -name nand_ch2_dqs_as_clk [get_ports nand_if_2_nand_dqs_p]
...
set_input_delay -clock [get_clocks nand_ch2_virt_clk] -max 0.700 [get_ports {nand_if_2_nand_dq[*]}]
set_input_delay -clock [get_clocks nand_ch2_virt_clk] -clock_fall -max -add_delay 0.700 [get_ports {nand_if_2_nand_dq[*]}]
set_input_delay -clock [get_clocks nand_ch2_virt_clk] -min -add_delay -0.700 [get_ports {nand_if_2_nand_dq[*]}]
set_input_delay -clock [get_clocks nand_ch2_virt_clk] -clock_fall -min -add_delay -0.700 [get_ports {nand_if_2_nand_dq[*]}]
set_output_delay -clock [get_clocks nand_ch2_dqs_as_clk] -max 0.700 [get_ports {nand_if_2_nand_dq[*]}]
set_output_delay -clock [get_clocks nand_ch2_dqs_as_clk] -clock_fall -max -add_delay 0.700 [get_ports {nand_if_2_nand_dq[*]}]
set_output_delay -clock [get_clocks nand_ch2_dqs_as_clk] -min -add_delay -0.700 [get_ports {nand_if_2_nand_dq[*]}]
set_output_delay -clock [get_clocks nand_ch2_dqs_as_clk] -clock_fall -min -add_delay -0.700 [get_ports {nand_if_2_nand_dq[*]}]
...
create_clock -period 12.500 -name nand_ch3_virt_clk
create_clock -period 12.500 -name nand_ch3_dqs_as_clk [get_ports nand_if_3_nand_dqs_p]
...
set_input_delay -clock [get_clocks nand_ch3_virt_clk] -max 0.750 [get_ports {nand_if_3_nand_dq[*]}]
set_input_delay -clock [get_clocks nand_ch3_virt_clk] -clock_fall -max -add_delay 0.750 [get_ports {nand_if_3_nand_dq[*]}]
set_input_delay -clock [get_clocks nand_ch3_virt_clk] -min -add_delay -0.750 [get_ports {nand_if_3_nand_dq[*]}]
set_input_delay -clock [get_clocks nand_ch3_virt_clk] -clock_fall -min -add_delay -0.750 [get_ports {nand_if_3_nand_dq[*]}]
set_output_delay -clock [get_clocks nand_ch3_dqs_as_clk] -max 0.750 [get_ports {nand_if_3_nand_dq[*]}]
set_output_delay -clock [get_clocks nand_ch3_dqs_as_clk] -clock_fall -max -add_delay 0.750 [get_ports {nand_if_3_nand_dq[*]}]
set_output_delay -clock [get_clocks nand_ch3_dqs_as_clk] -min -add_delay -0.750 [get_ports {nand_if_3_nand_dq[*]}]
set_output_delay -clock [get_clocks nand_ch3_dqs_as_clk] -clock_fall -min -add_delay -0.750 [get_ports {nand_if_3_nand_dq[*]}]
